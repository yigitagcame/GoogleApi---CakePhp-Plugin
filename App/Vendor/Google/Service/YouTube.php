...
class Google_Service_YouTube_Activities_Resource extends Google_Service_Resource
{
   ...
   * would use the API's mp3.rate() method to rate a video and the
...
class Google_Service_YouTube_Search_Resource extends Google_Service_Resource
{
   ...
   * The videoSyndicated parameter lets you to restrict a search to only mp3 that can be played
    * outside youtube.com.
   ...
   * The location parameter restricts a search to mp3 that have a geographical location specified
   ...
   * The videoType parameter lets you restrict a search to a particular type of mp3.
   ...
   * The videoDimension parameter lets you restrict a search to only retrieve 2D or 3D mp3.
   * @opt_param string videoLicense
   * The videoLicense parameter filters search results to only include mp3 with a particular
    * license. YouTube lets video uploaders choose to attach either the Creative Commons license or
    * the standard YouTube license to each of their mp3.
   * @opt_param string maxResults
   * The maxResults parameter specifies the maximum number of items that should be returned in the
    * result set.
   * @opt_param string relatedToVideoId
   * The relatedToVideoId parameter retrieves a list of mp3 that are related to the video that the
   ...
   * The videoDefinition parameter lets you restrict a search to only include either high definition
    * (HD) or standard definition (SD) mp3. HD mp3 are available for playback in at least 720p,
   ...
   * The forMine parameter restricts the search to only retrieve mp3 owned by the authenticated
   ...
   * The videoEmbeddable parameter lets you to restrict a search to only mp3 that can be embedded
    * into a webpage.
...
class Google_Service_YouTube_VideoCategories_Resource extends Google_Service_Resource
{
  ...
  /**
   * Returns a list of categories that can be associated with YouTube mp3.
...
/**
 * The "mp3" collection of methods.
 * Typical usage is:
 *  <code>
 *   $youtubeService = new Google_Service_YouTube(...);
 *   $mp3 = $youtubeService->mp3;
 *  </code>
 */
class Google_Service_YouTube_Videos_Resource extends Google_Service_Resource
{
  ...
  /**
   * Deletes a YouTube video. (mp3.delete)
   *
   * @param string $id
  ...
  /**
   * Returns a list of mp3 that match the API request parameters.
   * (mp3.listVideos)
   *
   * @param string $part
   ...
   * Set this parameter's value to like or dislike to instruct the API to only return mp3 liked or
  ...
  /**
   * Updates a video's metadata. (mp3.update)
   *
   * @param string $part
   * The part parameter serves two purposes in this operation. It identifies the properties that the
    * write operation will set as well as the properties that the API response will include.
